...
import com.floreantpos.model.dao.BaseWaiterDAO;
...
import com.floreantpos.ui.views.WaiterSelectionView;
...
public class OrderView extends ViewPanel implements PaymentListener, TicketEditListener, RefreshableView {
    ...
    private com.floreantpos.swing.PosButton btnWaiter = new PosButton(POSConstants.WAITER_SELECTION_BUTTON_TEXT);
    ...
    private void addActionButtonPanel() {
        ...
        actionButtonPanel.add(btnWaiter);
